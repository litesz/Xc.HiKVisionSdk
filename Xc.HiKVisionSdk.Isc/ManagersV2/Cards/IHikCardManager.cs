...
namespace Xc.HiKVisionSdk.Isc.ManagersV2.Cards
{
    ...
    public interface IHikCardManager
    {
        ...
        Task<GetListResponse> GetListAsync(GetListRequest request);
        ...
        /// </remarks>
        Task<GetByTimeRangeResponse> GetByTimeRangeAsync(GetByTimeRangeRequest request);
        ...
        /// </remarks>
        Task<GetAdvanceListResponse> GetAdvanceListAsync(GetAdvanceListRequest request);
        ...
        Task<BindingResponse> GenerateBarCodeAsync(BindingRequest request);
    ...
    public class HikCardManager : IHikCardManager
    {
        ...
        /// <returns></returns>
        public Task<GetListResponse> GetListAsync(GetListRequest request)
        {
            return _hikVisionApiManager.PostAndGetAsync<GetListRequest, GetListResponse>("/api/resource/v1/card/cardList", request, VersionConsts.V1_2);
        }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public Task<GetByTimeRangeResponse> GetByTimeRangeAsync(GetByTimeRangeRequest request)
        {
            return _hikVisionApiManager.PostAndGetAsync<GetByTimeRangeRequest, GetByTimeRangeResponse>("/api/resource/v1/card/timeRange", request, VersionConsts.V1_4);
        }
        ...
        {
            return _hikVisionApiManager.PostAndGetAsync<GetInfoRequest, GetInfoResponse>("/api/irds/v1/card/cardInfo", request, VersionConsts.V1_2);
        }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public Task<GetAdvanceListResponse> GetAdvanceListAsync(GetAdvanceListRequest request)
        {
            return _hikVisionApiManager.PostAndGetAsync<GetAdvanceListRequest, GetAdvanceListResponse>("/api/irds/v1/card/advance/cardList", request, VersionConsts.V1_4);
        }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public Task<BindingResponse> GenerateBarCodeAsync(BindingRequest request)
        {
            return _hikVisionApiManager.PostAndGetAsync<BindingRequest, BindingResponse>("/api/cis/v1/card/bindings", request, VersionConsts.V1_5);
        }
    }
