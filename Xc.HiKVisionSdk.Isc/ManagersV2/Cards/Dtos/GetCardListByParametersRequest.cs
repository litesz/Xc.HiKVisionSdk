...
namespace Xc.HiKVisionSdk.Isc.ManagersV2.Cards.Dtos
{
    ...
    /// 查询卡片列表请求
    /// </summary>
    public class GetCardListByParametersRequest : PagedRequest
    {
        /// <summary>
        /// 人员姓名,模糊查询
        /// </summary>
        ...
        public GetCardListByParametersRequest(int pageNo, int pageSize, string personName = "", string cardNo = "", bool? onlyLoss = null, string orderBy = "", bool isAsc = true) : base(pageNo, pageSize)
        {
        ...
        /// <returns></returns>
        public GetCardListByParametersRequest UsePersonIds(params string[] personIds)
        {
