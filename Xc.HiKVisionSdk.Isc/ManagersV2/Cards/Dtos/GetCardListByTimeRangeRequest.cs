...
namespace Xc.HiKVisionSdk.Isc.ManagersV2.Cards.Dtos
{
    ...
    /// 增量获取卡片数据请求
    /// </summary>
    public class GetCardListByTimeRangeRequest : PagedRequest
    {
        ...
        public GetCardListByTimeRangeRequest(int pageNo, int pageSize, DateTime startTime, DateTime? endTime = null) : base(pageNo, pageSize)
        {
