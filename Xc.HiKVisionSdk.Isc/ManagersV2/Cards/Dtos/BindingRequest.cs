...
namespace Xc.HiKVisionSdk.Isc.ManagersV2.Cards.Dtos
{
    ...
    /// 批量开卡请求
    /// </summary>
    public class BindingRequest : BaseRequest
    {
        /// <summary>
        /// 卡片最大截止有效时间
        /// </summary>
        ...
        /// 待开卡列表,最大支持50张卡
        /// </summary>
        public BindingRequestItem[] CardList { get; }
        ...
        public BindingRequest(DateTime startDate, DateTime endDate, params BindingRequestItem[] cardList)
        {
