...
namespace Xc.HiKVisionSdk.Isc.Managers.Resource
{
    ...
    public partial class HikResourceApiManager : IHikResourceApiManager
    {
        ...
        {
            return _hikVisionApiManager.PostAndGetAsync<AdvanceCameraListRequest, AdvanceCameraListResponse>("/artemis/api/resource/v1/camera/advance/cameraList", model, Const.V1_0);
        }
        ...
        {
            return _hikVisionApiManager.PostAndGetAsync<CamerasRequest, CamerasResponse>("/artemis/api/resource/v1/cameras", model, Const.V1_0);
        }
        ...
        {
            return _hikVisionApiManager.PostAndGetAsync<CamerasIndexCodeRequest, CamerasIndexCodeResponse>("/artemis/api/resource/v1/cameras/indexCode", model, Const.V1_0);
        }
