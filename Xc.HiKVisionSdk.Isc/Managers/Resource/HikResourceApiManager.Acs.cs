...
namespace Xc.HiKVisionSdk.Isc.Managers.Resource
{
    ...
    public partial class HikResourceApiManager : IHikResourceApiManager
    {
        ...
        {
            return _hikVisionApiManager.PostAndGetAsync<AcsDoorAdvanceAcsDoorListRequest, AcsDoorAdvanceAcsDoorListResponse>("/api/resource/v1/acsDoor/advance/acsDoorList", model, VersionConsts.V1);
        }
