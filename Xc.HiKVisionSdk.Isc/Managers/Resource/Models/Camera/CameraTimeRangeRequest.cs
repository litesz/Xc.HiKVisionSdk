...
namespace Xc.HiKVisionSdk.Isc.Managers.Resource.Models.Camera
{
    ...
    /// 增量获取监控点数据
    /// </summary>
    public class CameraTimeRangeRequest : PagedRequest
    {
        ...
        public CameraTimeRangeRequest(int pageNo, int pageSize, DateTime startTime, DateTime? endTime = null) : base(pageNo, pageSize)
        {
