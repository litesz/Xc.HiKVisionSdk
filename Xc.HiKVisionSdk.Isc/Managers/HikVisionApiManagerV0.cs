...
namespace Xc.HiKVisionSdk.Isc.Managers
{
    ...
    /// 
    /// </summary>
    public class HikVisionApiManagerV0 : IHikVisionApiManager
    {
        private readonly int _timeout = 10000;
        private readonly IscSdkOption _option;

        static HikVisionApiManagerV0()
        {
        ...
        public HikVisionApiManagerV0(IscSdkOption option)
        {
            _option = option;
        }
        ...
        public HikVisionApiManagerV0(IOptions<IscSdkOption> options) : this(options.Value)
        {
        ...
        public HikVisionApiManagerV0(string ak, string sk, string address, decimal ver) : this(new IscSdkOption
        {
            Ak = ak.Trim(),
            Sk = sk.Trim(),
